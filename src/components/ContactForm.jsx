      ...
      <Form noValidate validated={isValidated} onSubmit={handleSubmit}>
        <Form.Group className="mx-auto mb-3 form-group" controlId="name">
          ...
          <Form.Control.Feedback type="invalid">
            <h5>Le nom doit contenir au moin un caractère.</h5>
        ...
        <Form.Group className="mx-auto mb-3 form-group" controlId="email">
          ...
          <Form.Control
            ...
            placeholder="Veuillez entré votre adresse email"
          />
          <Form.Control.Feedback type="invalid">
            <h5>Veuillez saisir une adresse email valide.</h5>
          </Form.Control.Feedback>
        </Form.Group>
        <Form.Group className="mx-auto mb-3 form-group" controlId="message">
          ...
          <Form.Control.Feedback type="invalid">
            <h5>Veuillez saisir un message valide.</h5>
          </Form.Control.Feedback>
        </Form.Group>
        <Form.Group className="mx-auto text-center form-group">
          ...
          <Alert
            ...
            dismissible
          >
            <Alert.Heading>Votre message à bien été envoyé, je vous contact dans les meilleurs delais.</Alert.Heading>
          </Alert>
          <Alert
            show={danger}
            variant="danger"
